...
<template>
  ...
  <div class="px-6 py-10 text-center bg-white rounded-lg my-3 shadow">
    <p class="max-w-[900px] mx-auto text-xl">
      Lorem ipsum, dolor sit amet consectetur adipisicing elit. Sit accusamus
      dicta odit laudantium at, aperiam hic, nihil excepturi similique earum
      vitae maxime dolorem fugiat modi incidunt, eos dolorum explicabo aut.
    </p>
  </div>
</template>
